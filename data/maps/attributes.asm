...
ENDM
	...
	map_attributes DarkCaveMiddle, DARK_CAVE_MIDDLE, $09, 0
	...
	map_attributes VictoryRoadNew, VICTORY_ROAD_NEW, $1d, 0
	map_attributes VictoryRoadSideWater, VICTORY_ROAD_SIDE_WATER, $1d, 0
	map_attributes VictoryRoadSideCave, VICTORY_ROAD_SIDE_CAVE, $1d, 0
	...
	map_attributes GoldenrodMtNootHouse, GOLDENROD_MT_NOOT_HOUSE, $00, 0
	...
	map_attributes CianwoodDunesCoast, CIANWOOD_DUNES_COAST, $35, SOUTH
	connection south, CianwoodDunes, CIANWOOD_DUNES, -2
	
	map_attributes CianwoodDunesCoastCave, CIANWOOD_DUNES_COAST_CAVE, $09, 0
	map_attributes YotsubasHouse, YOTSUBAS_HOUSE, $00, 0
