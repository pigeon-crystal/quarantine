...
MapGroup_Dungeons:
	...
	map WhirlIslandLugiaChamber, TILESET_DARK_CAVE, CAVE, LANDMARK_WHIRL_ISLANDS, MUSIC_TENSION, TRUE, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	...
	map DarkCaveMiddle, TILESET_DARK_CAVE, CAVE, LANDMARK_DARK_CAVE, MUSIC_DARK_CAVE, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	...
	map VictoryRoadNew, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map VictoryRoadSideWater, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map VictoryRoadSideCave, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
...
MapGroup_Ecruteak:
	...
	map EcruteakEdwardHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map Route45Passage, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_45, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map DestroyedTown, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_45, MUSIC_NONE, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
;Andromega Sequence
	map Andromega1F, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_45, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega2F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_ROUTE_45, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega3F, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_45, MUSIC_ANDROMEGA, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega4F, TILESET_TRAIN_STATION, INDOOR, LANDMARK_ROUTE_45, MUSIC_ANDROMEGA, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega5F, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_ROUTE_45, MUSIC_ANDROMEGA, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega6F, TILESET_ICE_PATH, INDOOR, LANDMARK_ROUTE_45, MUSIC_ANDROMEGA, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega7F, TILESET_ICE_PATH, INDOOR, LANDMARK_ROUTE_45, MUSIC_ANDROMEGA, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega8F, TILESET_ICE_PATH, INDOOR, LANDMARK_ROUTE_45, MUSIC_ANDROMEGA, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega9F, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_45, MUSIC_ANDROMEGA, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map FixedTown, TILESET_JOHTO, ENVIRONMENT_5, LANDMARK_ROUTE_45, MUSIC_THISMIA, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map AndromegaFinal, TILESET_ICE_PATH, INDOOR, LANDMARK_ROUTE_45, MUSIC_TENSION, TRUE, PALETTE_NITE, FISHGROUP_DRATINI_2
...
MapGroup_Azalea:
	...
	map AzaleaMeadow, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_AZALEA_MEADOW, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodMtNootHouse, TILESET_HOUSE, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map VermilionEmptyHouse, TILESET_HOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map TinTowerRoof, TILESET_TOWER, ROUTE, LANDMARK_TIN_TOWER, MUSIC_TENSION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_CianwoodDunes:
	...
	map CianwoodDunesCoast, 	TILESET_JOHTO, ROUTE, LANDMARK_CIANWOOD_DUNES, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CianwoodDunesCoastCave, TILESET_CAVE, CAVE, LANDMARK_CIANWOOD_DUNES, MUSIC_LIGHTHOUSE, TRUE, PALETTE_DAY, FISHGROUP_OCEAN
	map YotsubasHouse, 			TILESET_HOUSE, INDOOR, LANDMARK_CIANWOOD_DUNES, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_KaijuGym:
	map KaijuGym, TILESET_CELADON_GYM, ROUTE, LANDMARK_CELADON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
