...
MapGroup_Blackthorn:
	...
	map Andromega2F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_ROUTE_45, MUSIC_TENSION, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega3F, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_45, MUSIC_TENSION, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega4F, TILESET_TRAIN_STATION, INDOOR, LANDMARK_ROUTE_45, MUSIC_TENSION, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega5F, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_ROUTE_45, MUSIC_TENSION, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega6F, TILESET_ICE_PATH, INDOOR, LANDMARK_ROUTE_45, MUSIC_TENSION, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega7F, TILESET_ICE_PATH, INDOOR, LANDMARK_ROUTE_45, MUSIC_TENSION, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega8F, TILESET_ICE_PATH, INDOOR, LANDMARK_ROUTE_45, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map Andromega9F, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_45, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map FixedTown, TILESET_JOHTO, ENVIRONMENT_5, LANDMARK_ROUTE_45, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI_2
	map AndromegaFinal, TILESET_ICE_PATH, INDOOR, LANDMARK_ROUTE_45, MUSIC_ANDROMEGA, TRUE, PALETTE_NITE, FISHGROUP_DRATINI_2
