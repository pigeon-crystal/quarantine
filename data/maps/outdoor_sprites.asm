...
; entries correspond to map groups
	...
	dw CianwoodDunesGroupSprites
	dw DragonsDepthsSprites
	dw KaijuGymGroupSprites
...
DragonsDepthsSprites:
	db SPRITE_WARRIOR
	db SPRITE_PHARMACIST
	db SPRITE_GURU
	; 3 of 9 max walking sprites
	db SPRITE_POKE_BALL
	db SPRITE_ROCK
	db SPRITE_SLAATEL
	db 0 ; end
	
KaijuGymGroupSprites:
	db SPRITE_MONSTER
	db SPRITE_ULTRAMAN
	db SPRITE_BUENA
	db SPRITE_TEACHER
