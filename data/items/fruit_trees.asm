...
; entries correspond to FRUITTREE_* constants
	...
	db BERRY		; AZALEA_MEADOW_1
	db BITTER_BERRY ; AZALEA_MEADOW_2
	db BLK_APRICORN ; AZALEA_MEADOW_3
	db WHT_APRICORN ; AZALEA_MEADOW_4
	db GOLD_BERRY	; AZALEA_MEADOW_5
	db MIRACLEBERRY ; AZALEA_MEADOW_6
	db PSNCUREBERRY ; AZALEA_MEADOW_7
	db MINT_BERRY	; AZALEA_MEADOW_8
	db GOLD_BERRY 	; ROUTE_45_PASSAGE
