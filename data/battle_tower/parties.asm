...
BattleTowerMons2:
	...
	db ODDITULLY
	db BRIGHTPOWDER
	db PSYCHIC_M, SHADOW_BALL, SOFTBOILED, COUNTER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MOTHOMEN
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, COMET_PUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons3:
	...
	db AMANIGO
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, FISSURE, DOUBLE_EDGE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db QWALLOP
	db BRIGHTPOWDER
	db MIMIC, PURSUIT, BRAVE_BIRD, SWIFT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons4:
	...
	db CAIRNIVORE
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, COMET_PUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db CANTOGETHA
	db BRIGHTPOWDER
	db GIGA_DRAIN, STOMP, PSYCH_UP, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons7:
	...
	db MOTHO
	db FOCUS_BAND
	db FLAIL, ENDURE, BODY_SLAM, MEGA_KICK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
