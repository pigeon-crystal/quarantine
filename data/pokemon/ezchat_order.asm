...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, PSYDUCK, PHANPY, NOMSTER, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
...
.hi_bi_pi: db CLEFFA, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, RADEON, SUNKERN, TEDDIURSA, VOLTORB, -1
