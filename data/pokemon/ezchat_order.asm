...
.a:        db EKANS, ARBOK, SEAKING, ARIADOS, NANUQUA, UNOWN, -1
.i:        db EEVEE, DOLMITE, GWUBBY, PILOSWINE, ONIX, -1
.u:        db ARCANINE, SUDOWOODO, WEEPINBELL, GNOMERCY, WOOPER, SWINUB, -1
...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, SCRUFFRUIT, MACHOKE, HOATOXIC, PSYDUCK, PHANPY, NOMSTER, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
...
.to_do:    db DODUO, DODRIO, SMEARGLE, KOFFING, TENTACRUEL, TOGETIC, TRANQUIEL, GOOSAPLING, METAPOD, DONPHAN, -1
...
.ne:       db NATU, XATU, -1
.no:       db ATTACKO, -1
.ha_ba_pa: db SEEL, STEELIX, SCORCHOPPR, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME, TYROGUE, CLOYSTER, TYRANITAR, -1
.hi_bi_pi: db CLEFFA, HOATOT, PIKACHU, CLEFABLE, PIDGEOT, FURBODA, PICHU, CLEFAIRY, CHARMANDER, STARYU, RADEON, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.ra:       db RAIKOU, RAICHU, CHANSEY, NOMSABRE, LAPRAS, VILEPLUME, LANTURN, -1
.ri:       db CHARMELEON, CHARIZARD, URSARING, -1
.ru:       db JYNX, LUGIA, -1
.re:       db MAGNETON, LEDIAN, WORMEEK, -1
.ro:       db VULPIX, -1
