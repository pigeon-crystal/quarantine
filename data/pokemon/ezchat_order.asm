...
.i:        db EEVEE, DOLMITE, SPINARAK, PILOSWINE, ONIX, -1
...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, HOATOXIC, PSYDUCK, PHANPY, NOMSTER, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
