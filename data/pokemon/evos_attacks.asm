...
AmbinniEvosAttacks:
	db EVOLVE_ITEM, THUNDERSTONE, ALAKAZAM
	db 0 ; no more evolutions
	db 1, THUNDERSHOCK
	db 1, CHARM
	db 8, THUNDER_WAVE
...
ChanseyEvosAttacks:
	db EVOLVE_HAPPINESS, TR_ANYTIME, ODDITULLY
	db 0 ; no more evolutions
	db 1, DIG
	db 19, SPIKE_CANNON
	db 22, SPIKES
...
ClibbleEvosAttacks:
	db EVOLVE_STAT, 40, ATK_LT_DEF, GIGUARD
	db EVOLVE_STAT, 40, ATK_GT_DEF, GIGERATOR 
	db 0 ; no more evolutions
	db 1, POUND
	db 1, HARDEN
	db 7, SPARK
