...
MonMenuIcons:
	...
	db ICON_CATERPILLAR ; TOBACOON, orig BAYLEEF
	db ICON_MOTH        ; OKAMIKAZE, orig MEGANIUM
	db ICON_MONSTER     ; RADEON, orig CYNDAQUIL
	db ICON_MONSTER     ; SCAULTER
	db ICON_MONSTER     ; SCORCHOPPR
	db ICON_MONSTER     ; FURSA, orig TOTODILE
