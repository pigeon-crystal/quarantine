...
MonMenuIcons:
	...
	db ICON_DUSMAUS	    ; DUSMAUS
	db ICON_HUMANSHAPE  ; AMBINNI
	...
	db ICON_BLOB        ; DUMBLOON
	db ICON_BLOB        ; ZEPPLIUM
	...
	db ICON_HUMANSHAPE     ; SAPPURA
	db ICON_HUMANSHAPE       ; LEAFFIGY
	db ICON_HUMANSHAPE       ; SAKURONNA
	db ICON_CUTTLE     ; CUTTLE
	db ICON_CUTTLE     ; TENDRILL
	db ICON_CUTTLE    ; CHANSEY
	...
	db ICON_BIRD        ; PEAUTY
	db ICON_BIRD        ; PEEKEYE
	db ICON_BIRD 	    ; PEACOLDER
	db ICON_BUG         ; SCYTHER
	db ICON_BUG         ; CLIBBLE
	db ICON_MONSTER ; GIGUARD
	db ICON_MONSTER  ; GIGERATOR
	db ICON_BUG         ; PINSIR
	db ICON_EQUINE      ; TAUROS
	db ICON_FISH        ; MAGIKARP
	db ICON_GYARADOS    ; GYARADOS
	db ICON_MANDELBLOB  ; MANDELBLOB
	db ICON_HELACTAL    ; DITTO
	db ICON_FOX         ; EEVEE
	...
	db ICON_BLOB        ; WIWRIGHT
	db ICON_BIGMON      ; WIRIGIBLE
