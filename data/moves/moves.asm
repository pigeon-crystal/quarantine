...
; entries correspond to constants/move_constants.asm
	...
	move DOUBLESLAP,   EFFECT_DOUBLE_HIT,         22, NORMAL,   	PHYSICAL,  90, 25,   0
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          18, NORMAL,   	PHYSICAL,  90, 15,   0
	move SHADOW_BONE,  EFFECT_DEFENSE_DOWN_HIT,   85, GHOST,    	PHYSICAL, 100, 10,  20
	move PAY_DAY,      EFFECT_PAY_DAY,            45, NORMAL,   	PHYSICAL, 100, 20,   0
	move FIRE_PUNCH,   EFFECT_BURN_HIT,           80, FIRE,     	PHYSICAL, 100, 15,  15
	move ICE_PUNCH,    EFFECT_FREEZE_HIT,         80, ICE,      	PHYSICAL, 100, 15,  15
	move THUNDERPUNCH, EFFECT_PARALYZE_HIT,       80, ELECTRIC, 	PHYSICAL, 100, 15,  15
	move SCRATCH,      EFFECT_NORMAL_HIT,         40, NORMAL,   	PHYSICAL, 100, 35,   0
	move DRAGON_DANCE, EFFECT_DRAGON_DANCE,        0, DRAGON,   	STATUS,   100, 20,   0
	move GUILLOTINE,   EFFECT_OHKO,                1, STEEL,   	    PHYSICAL,  30,  5,   0
	...
	move STOMP,        EFFECT_STOMP,              75, NORMAL,   	PHYSICAL, 100, 20,  35
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         32, FIGHTING, 	PHYSICAL, 100, 20,   0
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        125, NORMAL,   	PHYSICAL,  75,  5,   0
	...
	move HEART_STAMP,  EFFECT_FLINCH_HIT,         60, PSYCHIC_TYPE, PHYSICAL, 100, 20,  31
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL,   	PHYSICAL, 100, 15,  30
	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL,   	PHYSICAL,  91, 20,   0
	...
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    65, ICE,      	SPECIAL,  100, 20,  15
	...
	move BRAVE_BIRD,   EFFECT_RECOIL_HIT,        110, FLYING,   	PHYSICAL, 100, 15,   0
	move DRAININGKISS, EFFECT_LEECH_HIT,          55, FAIRY,    	SPECIAL,  100, 10,   0
	...
	move STRENGTH,     EFFECT_ATTACK_UP_HIT,      70, FIGHTING, 	PHYSICAL, 95, 15,   20
	move ABSORB,       EFFECT_LEECH_HIT,          32, GRASS,    	SPECIAL,  100, 25,   0
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          50, GRASS,    	SPECIAL,  100, 10,   0
	...
	move SOLARBEAM,    EFFECT_SOLARBEAM,         125, GRASS,    	SPECIAL,  100, 10,   0
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        15, FIRE,     	SPECIAL,   89, 15,   0
	...
	move ROCK_THROW,   EFFECT_ACCURACY_DOWN_HIT,  51, ROCK,     	PHYSICAL,  92, 20,  13
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,         95, GROUND,   	PHYSICAL, 100, 10,   0
	...
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC_TYPE, SPECIAL,  100, 25,  12
	...
	move PUKE_BLOOD,   EFFECT_RECOIL_HIT,        120, POISON,   	SPECIAL,  100, 15,   0
	...
	move SMOG,         EFFECT_POISON_HIT,         30, POISON,   	SPECIAL,   91, 20,  40
	...
	move HACKLES_UP,   EFFECT_SKULL_BASH,        120, FIGHTING,   	PHYSICAL, 100, 10,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          22, STEEL,   	    PHYSICAL, 95, 15,   0
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     30, BUG, 			PHYSICAL, 100, 35,  35
	...
	move DREAM_EATER,  EFFECT_DREAM_EATER,       130, PSYCHIC_TYPE, SPECIAL,  100, 10,   0
	move POISON_GAS,   EFFECT_POISON,              0, POISON,   	STATUS,    91, 40,   0
	move SNARL,        EFFECT_SP_ATK_DOWN_HIT,    55, DARK,     	SPECIAL,   95, 15, 100
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          80, BUG,      	PHYSICAL, 100, 10,   0
	move LOVELY_KISS,  EFFECT_SLEEP,               0, FAIRY,    	STATUS,    82, 10,   0
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        145, FLYING,   	PHYSICAL, 100,  5,   0
	...
	move REST,         EFFECT_REST,                0, PSYCHIC_TYPE, STATUS,   100, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,     	PHYSICAL,  92, 10,  30
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,   	PHYSICAL,  95, 15,  18
	move SHARPEN,      EFFECT_ATTACK_UP,           0, NORMAL,   	STATUS,   100, 30,   0
	move CONVERSION,   EFFECT_CONVERSION,         60, STEEL,   	    SPECIAL,  100, 30,   0
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        15, FIGHTING, 	PHYSICAL,  93, 10,   0
	...
	move SNORE,        EFFECT_SNORE,              85, NORMAL,   	SPECIAL,  100, 15,  30
	...
	move SHADOW_CLAW,  EFFECT_NORMAL_HIT,         75, GHOST,    	PHYSICAL, 100, 15,   0
	...
	move SWEET_KISS,   EFFECT_CONFUSE,             0, FAIRY,    	STATUS,    82, 10,   0
	move BELLY_DRUM,   EFFECT_BELLY_DRUM,          0, NORMAL,   	STATUS,   100, 10,   0
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         90, POISON,   	SPECIAL,  100, 10,  30
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  22, GROUND,   	SPECIAL,  100, 10, 100
	...
	move DETECT,       EFFECT_DETECT,              0, FIGHTING, 	STATUS,   100,  5,   0
	move BONE_RUSH,    EFFECT_MULTI_HIT,          24, GROUND,   	PHYSICAL,  90, 10,   0
	move LOCK_ON,      EFFECT_LOCK_ON,             0, NORMAL,   	STATUS,   100,  5,   0
	move OUTRAGE,      EFFECT_RAMPAGE,           111, DRAGON,   	PHYSICAL, 100, 15,   0
	...
	move NITROBLAZE,   EFFECT_SPEED_UP_HIT,       85, FIRE,     	PHYSICAL, 100, 10,  50
	move MAGNITUDE,    EFFECT_MAGNITUDE,           1, GROUND,   	PHYSICAL, 100, 30,   0
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       110, FIGHTING, 	PHYSICAL,  50,  5, 100
	move MEGAHORN,     EFFECT_NORMAL_HIT,        125, BUG,      	PHYSICAL,  85, 10,   0
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       75, DRAGON,   	SPECIAL,  100, 15,  25
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  105, STEEL,    	PHYSICAL,  75, 15,  30
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      50, STEEL,    	PHYSICAL,  95, 35,  10
	move VITAL_THROW,  EFFECT_ALWAYS_HIT,         75, FIGHTING, 	PHYSICAL, 100, 10,   0
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         65, ROCK,     	SPECIAL,  100,  5,  11
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,    	SPECIAL,  100, 15,  25
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      125, PSYCHIC_TYPE, SPECIAL,  100, 15,   0
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   55, FIGHTING, 	PHYSICAL,  95, 15,  50
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        40, WATER,    	SPECIAL,   90, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            20, DARK,     	PHYSICAL, 100, 10,   0
	move SHEKELSHOT,   EFFECT_PAY_DAY, 			  90, STEEL,    	PHYSICAL, 100, 10,   0
	move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,    90, FAIRY,    	SPECIAL,  100, 10,  20
