...
; entries correspond to constants/move_constants.asm
	...
	move DOUBLESLAP,   EFFECT_DOUBLE_HIT,         22, NORMAL,   PHYSICAL,  88, 10,   0
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          18, NORMAL,   PHYSICAL,  88, 15,   0
	...
	move CALM_MIND,    EFFECT_CALM_MIND,           0, PSYCHIC_T, STATUS,  100, 20,   0
	...
	move PSYBEAM,      EFFECT_CONFUSE_HIT,        65, PSYCHIC_T, SPECIAL, 100, 20,  10
	...
	move ABSORB,       EFFECT_LEECH_HIT,          31, GRASS,    SPECIAL,  100, 20,   0
	...
	move DIG,          EFFECT_FLY,                75, GROUND,   PHYSICAL, 100, 10,   0
	move TOXIC,        EFFECT_TOXIC,               0, POISON,   STATUS,    85, 10,   0
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC_T,  SPECIAL, 100, 25,  12
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC_T,  SPECIAL, 100, 10,  20
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC_T, STATUS,   60, 20,   0
	move LIQUIDATION,  EFFECT_DEFENSE_DOWN_HIT,   85, WATER,    PHYSICAL,  100, 10,  20
	move AGILITY,      EFFECT_SPEED_UP_2,          0, PSYCHIC_T, STATUS,   100, 30,   0
	...
	move TELEPORT,     EFFECT_TELEPORT,            0, PSYCHIC_T, STATUS,   100, 20,   0
	...
	move BARRIER,      EFFECT_DEFENSE_UP_2,        0, PSYCHIC_T, STATUS,  100, 30,   0
	move LIGHT_SCREEN, EFFECT_LIGHT_SCREEN,        0, PSYCHIC_T, STATUS,  100, 30,   0
	move HAZE,         EFFECT_RESET_STATS,         0, ICE,      STATUS,   100, 30,   0
	move REFLECT,      EFFECT_REFLECT,             0, PSYCHIC_T,  STATUS, 100, 20,   0
	...
	move ZEN_HEADBUTT, EFFECT_FLINCH_HIT,         90, PSYCHIC_T, PHYSICAL, 90, 15,  20
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        50, WATER,    PHYSICAL,  83, 10,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,   SPECIAL,  100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        140, NORMAL,   PHYSICAL, 100, 15,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, NORMAL,   PHYSICAL, 100, 15,   0
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     20, NORMAL,   PHYSICAL, 100, 35,  35
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC_T,  STATUS, 100, 20,   0
	...
	move DREAM_EATER,  EFFECT_DREAM_EATER,       140, PSYCHIC_T, SPECIAL, 100, 10,   0
	...
	move LOVELY_KISS,  EFFECT_SLEEP,               0, FAIRY,    STATUS,    75, 10,   0
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        140, FLYING,   PHYSICAL, 100,  5,   0
	...
	move PSYWAVE,      EFFECT_PSYWAVE,             1, PSYCHIC_T, SPECIAL, 100, 15,   0
	...
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         52, GROUND,   PHYSICAL,  90, 10,   0
	move REST,         EFFECT_HEAL,                0, PSYCHIC_T, STATUS,  100, 10,   0
	...
	move BONE_RUSH,    EFFECT_MULTI_HIT,          27, GROUND,   PHYSICAL,  90, 10,   0
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       75, DRAGON,   SPECIAL,  100, 15,  27
	...
	move TWISTER,      EFFECT_TWISTER,            48, DRAGON,   SPECIAL,  100, 20,  25
	...
	move MIRROR_COAT,  EFFECT_MIRROR_COAT,         1, PSYCHIC_T, SPECIAL, 100, 20,   0
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      125, PSYCHIC_T, SPECIAL, 100, 15,   0
