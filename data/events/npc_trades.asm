...
; entries correspond to NPCTRADE_* constants
	npctrade TRADE_DIALOGSET_COLLECTOR, AMBINNI,    ZASTER,     "HYUNDIE@@@@", $F7, $BD, METAL_COAT, 		37460, 		"MIKE@@@@@@@", TRADE_GENDER_EITHER
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, FURDOBA, 	LAMSEED,	"SHEP@@@@@@@", $ba, $ba, POLKADOT_BOW, 		30586, 		"AMANE@@@@@@", TRADE_GENDER_EITHER
