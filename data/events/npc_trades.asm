...
; entries correspond to NPCTRADE_* constants
	npctrade TRADE_DIALOGSET_COLLECTOR, AMBINNI,    ZASTER,     "HYUNDIE@@@@", $97, $ab, METAL_COAT, 		37460, 		"MIKE@@@@@@@", TRADE_GENDER_EITHER ; goldenrod department
	npctrade TRADE_DIALOGSET_GIRL,      LAWNIE,     SNOSEBLEED, "SQUATCH@@@@", $57, $99, BITTER_BERRY, 		48926, 		"KYLE@@@@@@@", TRADE_GENDER_FEMALE ; violet city
	...
	npctrade TRADE_DIALOGSET_GIRL,      CALARMOURI, AERODACTYL, "AEROY@@@@@@", $96, $66, GOLD_BERRY,   		26491, 		"KIM@@@@@@@@", TRADE_GENDER_EITHER ; route 14
