...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_GIRL,      SLOWHOG,  	ALIGRO,     "IFRIT@@@@@@", $77, $66, SMOKE_BALL,   		00283, 		"EMY@@@@@@@@", TRADE_GENDER_FEMALE ; blackthorn
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, ARASBESTOS,	MT_NOOT,	"NOBBLICE@@@", $e5, $89, ICE_BERRY, 		20520, 		"MR. POPPER@", TRADE_GENDER_EITHER ; goldenrod popper
	npctrade TRADE_DIALOGSET_COLLECTOR, HAUNTLET,	BUDGANEER,  "OZZY@@@@@@@", $f6, $c6, MIRACLEBERRY, 		21900,		"EDWARD@@@@@", TRADE_GENDER_EITHER ; ecruteak
