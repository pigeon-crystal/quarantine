...
; entries correspond to NPCTRADE_* constants
	npctrade TRADE_DIALOGSET_COLLECTOR, ABRA,       MACHOP,     "HYUNDIE@@@@", $37, $66, POLKADOT_BOW, 37460, "MIKE@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      LAWNIE,     CADDISICLE, "JADZIA@@@@@", $47, $df, BITTER_BERRY, 48926, "JULIAN@@@@@", TRADE_GENDER_FEMALE
