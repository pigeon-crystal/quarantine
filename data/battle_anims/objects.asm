...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_2A, BATTLEANIMFUNC_00, PAL_BATTLE_OB_RED, ANIM_GFX_WATER ; ANIM_OBJ_PUKE_BLOOD
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_02, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE  ; ANIM_OBJ_MOONBLAST
    battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_50, PAL_BATTLE_OB_GRAY, ANIM_GFX_MOON ; ANIM_OBJ_MOON
    battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_4C, BATTLEANIMFUNC_14, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE ; ANIM_OBJ_MOON_CHARGE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_51, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHARGE; ANIM_OBJ_POWER_GEM
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_56, BATTLEANIMFUNC_2C, PAL_BATTLE_OB_GREEN, $1d ; ANIM_OBJ_BULLET_SEED
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_02, PAL_BATTLE_OB_YELLOW, $0c  ; ANIM_OBJ_CAT
