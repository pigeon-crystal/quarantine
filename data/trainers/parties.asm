...
WillGroup:
	...
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, STOMP, PSYCHIC_M
...
SwimmerFGroup:
	...
	db 21, HORSEA,     SONICBOOM, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
BlueGroup:
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, GIGA_DRAIN, SOLARBEAM
