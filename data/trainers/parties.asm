...
ChampionGroup:
	...
	db 44, ATTACKO,   FLAIL, RAIN_DANCE, SURF, HYPER_BEAM
...
;	db 46, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 46, NOMSTER,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
...
GuruGroup:
	...
	db 40, DRASSAL
		dw $4EBA, $4EBA, $4EBA, $4EBA, $FEBA
		db BERRY
		db PROTECT, DRAGONBREATH, FLY, THIEF
	db -1 ; end
