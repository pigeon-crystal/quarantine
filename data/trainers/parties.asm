...
FalknerGroup:
	...
	db 10, HOOTHOOT,   PECK, MUD_SLAP, MOONLIGHT, NO_MOVE
	db 12, FURNIT,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
...
Rival1Group:
	...
	db 32, OKAMIKAZE,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, SCAULTER,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, URSKIMO, WATERFALL, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
...
YoungsterGroup:
	...
	db  5, NOMSTER, TACKLE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
	...
	; YOUNGSTER (8)
	db "JOEY@", TRAINERTYPE_MOVES
	db 21, NOMSABRE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_SWIPES, FOCUS_ENERGY, TWINEEDLE, TWINEEDLE
