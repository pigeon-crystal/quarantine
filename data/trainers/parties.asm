...
KogaGroup:
	...
	db 42, MUK,        MINIMIZE, BARRIER, SLUDGE_BOMB, TOXIC
...
BurglarGroup:
	...
	db 24, KOFFING,    POUND, SMOG, SLUDGE_BOMB, SMOKESCREEN
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, KOFFING,    POUND, SLUDGE_BOMB, SMOKESCREEN, HAZE
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, KOFFING,    POUND, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db 30, KOFFING,    POUND, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db 30, KOFFING,    POUND, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db 32, WEEZING,    POUND, EXPLOSION, SLUDGE_BOMB, SMOKESCREEN
	db 30, KOFFING,    POUND, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db 30, KOFFING,    POUND, SMOG, SLUDGE_BOMB, SMOKESCREEN
	db -1 ; end
