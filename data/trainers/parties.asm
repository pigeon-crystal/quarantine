...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, STINPEON,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, NANUQUA,   LEER, TACKLE, WATER_GUN, BITE
	db -1 ; end
...
BeautyGroup:
	...
	db 17, PURRDLE,   SYNTHESIS, TAIL_WHIP, TACKLE, STUN_SPORE
	db -1 ; end
...
BurglarGroup:
	...
	db 24, KOFFING,    TACKLE, SMOG, SLUDGE_BOMB, SMOKESCREEN
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, KOFFING,    TACKLE, SLUDGE_BOMB, SMOKESCREEN, HAZE
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db 32, WEEZING,    TACKLE, EXPLOSION, SLUDGE_BOMB, SMOKESCREEN
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db 30, KOFFING,    TACKLE, SMOG, SLUDGE_BOMB, SMOKESCREEN
	db -1 ; end
