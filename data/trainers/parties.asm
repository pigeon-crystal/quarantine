...
BugCatcherGroup:
	...
	db 25, NOXROMAEUS,   FURY_SWIPES, FOCUS_ENERGY, TWINEEDLE, TWINEEDLE
	...
	db 32, NOXROMAEUS,   FURY_SWIPES, PURSUIT, TWINEEDLE, DOUBLE_TEAM
...
FisherGroup:
	...
	db 35, QWILFISH,   TOXIC, MINIMIZE, SURF, TWINEEDLE
	...
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_SWIPES
	db 37, QWILFISH,   ROLLOUT, SURF, TWINEEDLE, DOUBLE_EDGE
	db -1 ; end
