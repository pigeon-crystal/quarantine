...
BugsyGroup:
	...
	db 20, ORGNOME
		db PERFECT_DV, PERFECT_DV
		dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, $0f7a
		db BERRY
...
Rival1Group:
	...
	db 20, GOOSAPLING, 	BERRY, 		BUBBLE, WRAP, SUPERSONIC, ROCK_THROW
	db 22, TOBACOON, 	GOLD_BERRY, 	MEGA_DRAIN, STUN_SPORE, CONSTRICT, HAZE
	db -1 ; end

	; RIVAL1 (5) Azalea, chose cigerillar
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 19, ARASBESTOS, 	POISON_BARB, 	SPIKES, ROCK_THROW, CONSTRICT, POISON_STING
	db 20, KOAGAN, 		BERRY, 		STOMP, CUT, POISONPOWDER, POISON_STING
	db 22, SCAULTER, 	GOLD_BERRY,	 	ROAR, EMBER, METAL_CLAW, QUICK_ATTACK
	db -1 ; end
	...
	db 19, ARASBESTOS, 	POISON_BARB, 	SPIKES, ROCK_THROW, CONSTRICT, POISON_STING
	db 20, GOOSAPLING, 	BERRY, 		BUBBLE, WRAP, SUPERSONIC, ROCK_THROW
	db 22, NANUQUA, 	GOLD_BERRY, 	SHARPEN, PURSUIT, ICY_WIND, WATER_GUN
	db -1 ; end
	...
	db 35, AMBINNI,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
...
LassGroup:
	...
	db 18, ZASTER,   SCARY_FACE, CHARM, BITE, LICK
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, SAPPURA,  LICK, SUPERSONIC, CUT, NO_MOVE
	db -1 ; end
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, METRONOME, SOFTBOILED
	db -1 ; end
...
FisherGroup:
	...
	db 35, QWILFISH,   TOXIC, MINIMIZE, SURF, SPIKE_CANNON
	...
	db 34, GANZERKER,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_SWIPES
	db 37, QWILFISH,   ROLLOUT, SURF, SPIKE_CANNON, DOUBLE_EDGE
	db -1 ; end
...
PsychicGroup:
	...
	db 13, DUSMAUS,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 13, DUSMAUS,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 15, AMBINNI,    TELEPORT, CONFUSION, NO_MOVE, NO_MOVE
	db -1 ; end

	; PSYCHIC_T (8)
	db "PHIL@", TRAINERTYPE_MOVES
	db 24, NATU,       LEER, NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY
	db 26, AMBINNI,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db -1 ; end
