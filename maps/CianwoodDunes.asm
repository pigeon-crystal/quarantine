...
CianwoodDunes_MapEvents:
	...
	object_event 25, 29, SPRITE_FANATIC, 		SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 0, CianwoodDunesYamato, -1
	object_event 25, 28, SPRITE_DELINQUENT_M, 	SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 0, CianwoodDunesTakeo, -1
