...
UnknownText_0x6c414:									; TODO, figure out what to do with Rocket's plan and Dragonite
	text "Hello, kiddo!"
...
MahoganyMart1F_MapEvents:
	...
	object_event  3,  6, SPRITE_BRIGADOOM, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MAHOGANY_MART_LANCE_AND_DRAGONITE
