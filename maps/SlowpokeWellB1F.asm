...
TrainerEnforcer:
	trainer ENFORCER, ENFORCER_1, EVENT_BEAT_ENFORCER_WELL, GruntM1SeenText, GruntM1BeatenText, 0, .Script
...
SlowpokeWellB1F_MapEvents:
	...
	object_event  5,  2, SPRITE_ENFORCER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerEnforcer, EVENT_SLOWPOKE_WELL_ROCKETS
	...
	object_event  7,  4, SPRITE_CUTTLE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB1FSlowpokeWithMailScript, EVENT_SLOWPOKE_WELL_SLOWPOKES
	object_event  6,  2, SPRITE_CUTTLE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB1FTaillessSlowpokeScript, EVENT_SLOWPOKE_WELL_SLOWPOKES
