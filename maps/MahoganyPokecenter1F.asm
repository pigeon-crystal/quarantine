...
MahoganyPokecenter1F_MapEvents:
	...
	object_event  7,  2, SPRITE_BREEDER_M, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, MahoganyPokecenter1FPokefanMScript, -1
