...
Route40HiddenHyperPotion:
	hiddenitem FULL_RESTORE, EVENT_ROUTE_40_HIDDEN_HYPER_POTION
...
Route40AthleteDoc:
	trainer ATHLETE_M, DOC, EVENT_ROUTE40_ATHLETE_DOC, AthleteDocSeenText, AthleteDocBeatenText, 0, .Script

.Script:
	endifjustbattled
	opentext
	writetext AthleteDocAfterText
	waitbutton
	closetext
	end
...
Route40_MapEvents:
	...
	object_event 14,  7, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route40StandingYoungsterScript, EVENT_BATTLE_TOWER_OUTSIDE_SAILOR
	object_event 12,  8, SPRITE_ATHLETE_M, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, Route40AthleteDoc, -1
