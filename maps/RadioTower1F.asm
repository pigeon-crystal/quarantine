...
TrainerGruntM3:
	trainer ENFORCER, ENFORCER_2, EVENT_BEAT_ROCKET_GRUNTM_3, GruntM3SeenText, GruntM3BeatenText, 0, .Script
...
RadioTower1F_MapEvents:
	...
	object_event 14,  1, SPRITE_ENFORCER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerGruntM3, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
