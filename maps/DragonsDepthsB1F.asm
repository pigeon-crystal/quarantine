...
DragonsDepthsB1F_MapEvents:
	...
	db 10 ; object events
	object_event 13, 16, SPRITE_WARRIOR, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 4, TrainerWarriorShindo, -1
	object_event  4, 16, SPRITE_WARRIOR, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerWarriorMalmess, -1
	object_event 17,  3, SPRITE_WARRIOR, SPRITEMOVEDATA_WANDER, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 4, TrainerWarriorKazuo, -1
	...
	object_event 23, 10, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DragonsDepthsB1FStarPiece, EVENT_DRAGONS_DEPTHS_B1F_STAR_PIECE
