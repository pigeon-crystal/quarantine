...
WhirlIslandLugiaChamber_MapEvents:
	...
	db 1 ; object events
	object_event  9,  5, SPRITE_AVATRICE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Lugia, EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_LUGIA
