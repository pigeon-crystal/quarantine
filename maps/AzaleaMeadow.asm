...
AzaleaMeadow_MapEvents:
	...
	db 14 ; object events
	object_event 14, 25, SPRITE_BREEDER_F, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, TrainerBreederDonna, -1
	...
	object_event 0, 19, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, AzaleaMeadowPokeDoll, EVENT_MEADOW_ITEMBALL1
