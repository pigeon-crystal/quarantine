...
CyndaquilPokeBallScript:
	...
	promptbutton
	waitsfx
	getmonname STRING_BUFFER_3, RADEON
	writetext ReceivedStarterText
	playsound SFX_CAUGHT_MON
	waitsfx
	promptbutton
	givepoke RADEON, 5, BERRY
	closetext
	readvar VAR_FACING
...
TotodilePokeBallScript:
	...
	promptbutton
	waitsfx
	getmonname STRING_BUFFER_3, FURSA
	writetext ReceivedStarterText
	playsound SFX_CAUGHT_MON
	waitsfx
	promptbutton
	givepoke FURSA, 5, BERRY
	closetext
...
ChikoritaPokeBallScript:
	...
	promptbutton
	waitsfx
	getmonname STRING_BUFFER_3, CIGERILLAR
	writetext ReceivedStarterText
	playsound SFX_CAUGHT_MON
	waitsfx
	promptbutton
	givepoke CIGERILLAR, 5, BERRY
	closetext
...
ElmGiveEverstoneText2:
	...
	para "Hope it'll help"
	line "with filling out"
	cont "your #DEX!"
	done
