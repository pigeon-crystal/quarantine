...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_AZALEA_MEADOW_1 ; 1f
	const FRUITTREE_AZALEA_MEADOW_2 ; 20
	const FRUITTREE_AZALEA_MEADOW_3 ; 21
	const FRUITTREE_AZALEA_MEADOW_4 ; 22
	const FRUITTREE_AZALEA_MEADOW_5 ; 23
	const FRUITTREE_AZALEA_MEADOW_6 ; 24
	const FRUITTREE_AZALEA_MEADOW_7 ; 25
	const FRUITTREE_AZALEA_MEADOW_8 ; 26
	const FRUITTREE_ROUTE_45_PASSAGE ; 27
